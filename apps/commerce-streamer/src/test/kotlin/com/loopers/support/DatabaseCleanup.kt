...
class DatabaseCleanup(
    ...
    override fun afterPropertiesSet() {
        tables = em.metamodel.entities
            ...
            .map { entityType ->
                ...
                TableInfo(tableName, BaseEntity::class.java.isAssignableFrom(entityType.javaType))
            }
    }
    ...
    fun execute() {
        ...
        tables.forEach { table ->
            ...
            if (table.hasIdentityId) {
                em.createNativeQuery("ALTER TABLE ${table.name} AUTO_INCREMENT = 1").executeUpdate()
            }
        }
        em.createNativeQuery("SET FOREIGN_KEY_CHECKS = 1").executeUpdate()
    }

    private data class TableInfo(val name: String, val hasIdentityId: Boolean)

...
interface RankingRolloverPort {
    ...
    fun tryStart(version: String, targetDate: LocalDate): Boolean
     ...
     */
    fun carryOverSnapshot(version: String, fromDate: LocalDate, toDate: LocalDate)

    /** 이월 완료 표시 — status를 DONE으로 덮어쓴다. 이후 요청부터 정상 경로. */
    fun complete(version: String, targetDate: LocalDate)

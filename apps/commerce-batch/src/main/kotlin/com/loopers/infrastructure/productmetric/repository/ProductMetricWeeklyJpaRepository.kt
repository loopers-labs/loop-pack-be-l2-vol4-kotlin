...
import com.loopers.infrastructure.productmetric.entity.ProductMetricWeeklyEntity
...
interface ProductMetricWeeklyJpaRepository : JpaRepository<ProductMetricWeeklyEntity, Long> {
    fun findByBaseDateAndProductId(
        baseDate: LocalDate,
        productId: Long,
    ): ProductMetricWeeklyEntity?

...
risk: safe
source: self
tags: "[external-integration, transaction, consistency, idempotency, failure-scenario]"
date_added: "2026-06-25"
---

외부 시스템 연동 설계를 분석할 때 반드시 다음 흐름을 따른다.

### 1. 기능이 아니라 "불확실성" 관점으로 재해석한다
- 단순 호출 순서를 요약하지 않는다.

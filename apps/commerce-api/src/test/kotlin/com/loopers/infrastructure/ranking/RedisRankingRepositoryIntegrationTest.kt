...
class RedisRankingRepositoryIntegrationTest @Autowired constructor(
    ...
    fun returnsEntriesInScoreDescOrderWithRank() {
        ...
        val page = rankingRepository.findPage(date, PageRequest.of(0, 10))
    ...
    fun paginationOffsetReflectedInRank() {
        ...
        val page = rankingRepository.findPage(date, PageRequest.of(1, 2))
    ...
    fun findRankReturnsOneBasedOrNull() {
        ...
        assertThat(rankingRepository.findRank(date, 200L)).isEqualTo(2L)
        assertThat(rankingRepository.findRank(date, 999L)).isNull()
    }
    ...
    fun emptyDateReturnsEmptyPage() {
        ...
        val page = rankingRepository.findPage(LocalDate.of(2026, 1, 1), PageRequest.of(0, 10))

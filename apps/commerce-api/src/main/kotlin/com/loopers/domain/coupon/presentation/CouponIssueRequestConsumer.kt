...
import com.loopers.domain.coupon.application.service.CouponIssueRequestPayload
...
class CouponIssueRequestConsumer(
    ...
    @KafkaListener(
        topics = ["\${commerce-events.coupon-issue-request.topic-name:coupon-issue-requests}"],
    ...
    fun consume(
        ...
        val payload = objectMapper.readValue<CouponIssueRequestPayload>(event.payload)

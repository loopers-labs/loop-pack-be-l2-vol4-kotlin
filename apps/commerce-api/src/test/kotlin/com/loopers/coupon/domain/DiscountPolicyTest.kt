...
class DiscountPolicyTest {
    ...
    fun giveAppropriateTest(type: CouponType, value: Long, price: Long, expectedMoney: Money) {
    ...
    fun capsDiscountAtPrice_whenDiscountExceedsOrderAmount() {
        val discount = DiscountPolicy.calculateDiscount(couponType = CouponType.FIXED, value = 15000L, price = 10000L)
    ...
    companion object {
        ...
        fun discountCases() = listOf(
            Arguments.of(CouponType.RATE, 10L, 10000L, Money(1000)),
            Arguments.of(CouponType.FIXED, 2000L, 10000L, Money(2000)),
        )
    }
}

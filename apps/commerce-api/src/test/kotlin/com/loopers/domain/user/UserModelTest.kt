...
class UserModelTest {
    ...
    inner class Create {
        ...
        @Test
        fun createsUserModel_whenValidInfoIsProvided() {
            // act
            val user = UserModel(loginId = LOGIN_ID, password = PASSWORD, name = NAME, birthDate = BIRTH_DATE, email = EMAIL)
    ...
    inner class InvalidLoginId {
        ...
        fun throwsBadRequest_whenLoginIdIsBlank() {
            ...
            val result = assertThrows<CoreException> {
                UserModel(loginId = invalidLoginId, password = PASSWORD, name = NAME, birthDate = BIRTH_DATE, email = EMAIL)
            }
    ...
    inner class InvalidName {
        ...
        fun throwsBadRequest_whenNameIsBlank() {
            ...
            // act
            val result = assertThrows<CoreException> {
                UserModel(loginId = LOGIN_ID, password = PASSWORD, name = invalidName, birthDate = BIRTH_DATE, email = EMAIL)
            }
    ...
    inner class InvalidBirthDate {
        ...
        fun throwsBadRequest_whenBirthDateIsBlank() {
            ...
            // act
            val result = assertThrows<CoreException> {
                UserModel(loginId = LOGIN_ID, password = PASSWORD, name = NAME, birthDate = invalidBirthDate, email = EMAIL)
            }
    ...
    inner class InvalidEmail {
        ...
        fun throwsBadRequest_whenEmailIsBlank() {
            ...
            // act
            val result = assertThrows<CoreException> {
                UserModel(loginId = LOGIN_ID, password = PASSWORD, name = NAME, birthDate = BIRTH_DATE, email = invalidEmail)
            }
    ...
    @DisplayName("Password 파라미터 유효성 체크")
    @Nested
    inner class InvalidPassword {
        ...
        fun throwsBadRequest_whenPasswordIsBlank() {
            ...
            // act
            val result = assertThrows<CoreException> {
                UserModel(loginId = LOGIN_ID, password = invalidPassword, name = NAME, birthDate = BIRTH_DATE, email = EMAIL)
            }
